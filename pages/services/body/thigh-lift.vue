  ...
  <div class="services-details">
    <div class="services-section">
      ...
      <p>
        ...
        extreme weight loss due to diet, exercise or bariatric surgery. Because
        of this, the procedure is often combined with others such as breast
        lifts, facelifts and arm lifts to retain an attractive body proportion.
      </p>
      <p>
        In a medial thigh lift (inner thigh lift), the surgical incision is made
        in the inner thigh along the line where the leg meets the groin. In a
        lateral thigh lift (outer thigh lift), the incision is made from the
        groin around the back of the body, so that the buttocks are lifted along
        with the thigh.
      </p>
    </div>
  </div>
