...
const faqs = [
 ...
 and post-operative scar care instructions will be provided to optimize the healing process.`
  ...
  {
    question: "What is the recommended age range for breast reduction patients?",
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Large breasts can cause pain, improper posture, rashes, breathing problems, skeletal deformities, and low self-esteem. '
    }
  ],
})
</script>
